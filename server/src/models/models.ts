...
import {
	FilmDetailsModelStatic,
	FilmModelStatic,
	FilmRatingInterfaceStatic
} from '../interfaces/models/films.model.interface'
import { UserModelInterfaceStatic } from '../interfaces/models/user.model.interface'
...
Film.hasMany(UserRating, { as: 'userRating', foreignKey: 'filmId' })
